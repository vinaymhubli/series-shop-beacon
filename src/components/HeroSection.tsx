      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className={`max-w-3xl transition-all duration-1500 delay-300 transform ${
          ...
          <div className={`flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 transition-all duration-1000 delay-1100 transform ${
            ...
            <Button variant="outline" className="group bg-white border-2 border-gray-400 text-black hover:bg-gray-100 hover:text-black px-10 py-4 text-lg font-semibold transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-white/25 relative overflow-hidden">
