      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-black rounded-lg p-6 hover:bg-gray-800 transition-colors duration-300">
                <h3 className="text-red-500 text-4xl font-bold mb-2">{stat.number}</h3>
                <h4 className="text-white text-xl font-semibold mb-2">{stat.label}</h4>
